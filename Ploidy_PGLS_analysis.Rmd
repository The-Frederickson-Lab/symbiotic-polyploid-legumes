...
summary(model_sub2)
Anova(model_sub2, contrasts=list(topic=contr.sum, sys=contr.sum), type=3)
...
Anova(model_sub_non, type=3,  contrasts=list(topic=contr.sum))
...
Anova(model_sub_sym, type=3,  contrasts=list(topic=contr.sum))
