...
- While we found a marginally significant interaction between symbiosis and ploidy in our main model, when we subsetted the data to non-symbiotic species, we uncovered a significant effect of ploidy on range expansion. Non-symbiotic polyploids were introduced to more ranges than non-symbiotic diploids and there was no difference between symbiotic diploids and symbiotic polyploids. Within symbiotic species, we found that specificity on rhizobia and ploidy interact significantly on range expansion. Generalist polyploids have spread to far more ranges around the globe than any other category of legume. We also found evidence of a high rate of re-diploidization in symbiotic legume lineages. 
